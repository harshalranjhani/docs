...
`--template`: Specifies the template to be used for generating the README file. The available options are `default`, `minimal`, and `detailed`. This flag is optional and defaults to `default`.
